                    ...
                    <div className="pt-5 mx-5 md:w-96 pb-10">
                        ...
                        <form action="" className="w-full justify-center mb-2">
                            <input
                                ...
                                id="email"
                                placeholder="Email"
                                className="rounded-2xl py-3 px-10 w-full border-none text-black bg-slate-100 mb-5 focus:outline-green-500"
                            />
                        ...
                        <button className="bg-transparent text-green-500 w-full py-2 rounded-full font-semibold mb-2">
                            Forgot Password
                        </button>
                        ...
                        <p className="text-slate-500 text-center mt-5">
                            ...
                            <Link href={route("signuptes")}>
                                <button className="text-green-500 px-2">
                                    Sign up
                                </button>
                            </Link>
                        </p>
