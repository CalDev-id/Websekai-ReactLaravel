                ...
                <div className="mx-5 mt-5">
                    ...
                    <div className="flex justify-between py-2">
                        <div className="rounded-full border-2 bg-green-500 flex w-[49%] justify-center border-green-500 text-white">
                            <span className="text-xl self-center"><i class='bx bx-play'></i></span>
                        ...
                        <div className="rounded-full border-2 flex w-[49%] py-1 justify-center border-green-500 text-green-500">
                            <span className="text-xl self-center"><i class='bx bx-cloud-download'></i></span>
                            <p className="self-center font-bold">Download</p>
                        </div>
                    </div>

                    <div className="py-2 text-sm text-white">
                        <p className="mb-1">Genre: Action, Martial Arts, Adventure, Dark Fantasy..</p>
                        <p className="text-slate-300">Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati veritatis praesentium reprehenderit libero perspiciatis non consectetur... <span className="text-green-500">View More</span></p>
                    </div>

                    <div className="flex text-white font-bold justify-between mb-3">
                        <p>Anime List</p>
                        <p className="text-green-500 font-normal">View More<i class='bx bx-chevron-down' ></i></p>
                    </div>
                    <Browse/>
                </div>
            </div>
