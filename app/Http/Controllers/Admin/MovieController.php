...
class MovieController extends Controller
{
    ...
    {   
        ...
        // return $request->all();
        return redirect()->route('admin.dashboard.movie.index')->with(['message' => 'Movie created successfully', 'type' => 'success']);
    }
    ...
    {
        $movie->delete();
        return redirect(route('admin.dashboard.movie.index'))->with(['message' => 'Movie deleted successfully', 'type' => 'success']);
    }
}
